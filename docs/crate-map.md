...
| `activity/` | Activity feed read models | `list_activity_events` |
...
| `config/` | Runtime DB pool configuration | `connect_pool` |
...
| `pool/` | Pool rally loadouts and persist | pool read/write helpers |
