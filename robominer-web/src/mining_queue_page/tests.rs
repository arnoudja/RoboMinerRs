...
fn mining_queue_rendering_preserves_controls_and_escapes_fields() {
        ...
        assert!(html.contains(r#"type="button" class="mining-queue-remove-btn" data-queue-item-id="101""#));
        ...
        assert!(html.contains(r#"id="miningArea1" name="miningArea1" class="tableitem mining-queue-area-select""#));
        ...
        assert!(html.contains(r#"Upfront costs:</td></tr><tr><td></td><td>Ore &amp; Two:</td><td>30</td>"#));
        assert!(html.contains(r#"class="mining-queue-area-panel"><tr><td>Tax rate:</td><td colspan="3">5%</td></tr>"#));
        ...
        assert!(html.contains(r#">Ore &amp; Two</span><span class="mining-queue-wallet-amount">40/100</span>"#));
        assert!(html.contains(r#"href="robot?robotId=1">Bot &lt;One&gt;</a>"#));
        assert!(html.contains(r#"mining-queue-status-mining">Mining</span>"#));
        assert!(html.contains(r#"data-seconds-left="60" data-refresh-on-complete="true" data-progress-total="120""#));
