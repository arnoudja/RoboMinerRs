...
fn rally_view_rendering_escapes_slots_and_javascript_ore_names() {
    ...
    assert_contains_all(
        ...
        &[
            ...
            r#"role="slider""#,
            r#"aria-valuetext="Robot turn 0 of 0""#,
            r#"class="rally-view-keyboard-hint""#,
            "← → one CPU instruction (when paused)",
            "Shift+← → next robot turn",
...
fn rally_view_highlights_viewer_robot_and_shows_context() {
    ...
    assert_contains_all(
        ...
        &[
            ...
            "Highlighted token is the program work running this CPU instruction. Source is the private snapshot from this rally.",
