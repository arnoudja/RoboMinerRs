...
values (1002, 1, 'AI-Cerbonium', 'move(1.5); while (mine());',
...
insert into Robot (id, userId, robotName, sourceCode,
 rechargeTime, maxOre, miningSpeed, maxTurns, cpuSpeed, forwardSpeed, backwardSpeed, rotateSpeed, robotSize)
values (1102, 1, 'AI-Oxaria', 'if (move(1.5) >= 1) { while (mine()); } else { move(-1); rotate(41); }',
...
'int rot = 0; while (true) { if (rot) { if (rot <= 90) { rotate(rot); } rot = rot - 10; } if (move(1.5) < 1) { move(-1); rotate(24); } while (mine()) { rot = 100; } }',
 0,            50,     2,           5000,     99,       3,            1,             36,          2.1) ON DUPLICATE KEY UPDATE userId = VALUES(userId), robotName = VALUES(robotName), sourceCode = VALUES(sourceCode), rechargeTime = VALUES(rechargeTime), maxOre = VALUES(maxOre), miningSpeed = VALUES(miningSpeed), maxTurns = VALUES(maxTurns), cpuSpeed = VALUES(cpuSpeed), forwardSpeed = VALUES(forwardSpeed), backwardSpeed = VALUES(backwardSpeed), rotateSpeed = VALUES(rotateSpeed), robotSize = VALUES(robotSize);
...
insert into OrePriceAmount (orePriceId, oreId, amount)
                    values (10003,      1,     1);
insert into MiningArea (id,   areaName,             orePriceId, sizeX, sizeY, maxMoves, miningTime, taxRate, aiRobotId)
                values (1003, 'Cerbonium-Advanced', 10003,      20,    20,    100,      15,         0,       1102) ON DUPLICATE KEY UPDATE areaName = VALUES(areaName), orePriceId = VALUES(orePriceId), sizeX = VALUES(sizeX), sizeY = VALUES(sizeY), maxMoves = VALUES(maxMoves), miningTime = VALUES(miningTime), taxRate = VALUES(taxRate), aiRobotId = VALUES(aiRobotId);
insert into MiningAreaOreSupply (miningAreaId, oreId, supply, radius)
                         values (1003,         1,     8,      7),
                                (1003,         1,     6,      5);
...
insert into OrePriceAmount (orePriceId, oreId, amount)
                    values (11001,      1,     1);
insert into MiningArea (id,   areaName,       orePriceId, sizeX, sizeY, maxMoves, miningTime, taxRate, aiRobotId)
                values (1101, 'Oxaria-Light', 11001,      20,    20,    60,       20,         25,      1102) ON DUPLICATE KEY UPDATE areaName = VALUES(areaName), orePriceId = VALUES(orePriceId), sizeX = VALUES(sizeX), sizeY = VALUES(sizeY), maxMoves = VALUES(maxMoves), miningTime = VALUES(miningTime), taxRate = VALUES(taxRate), aiRobotId = VALUES(aiRobotId);
insert into MiningAreaOreSupply (miningAreaId, oreId, supply, radius)
                         values (1101,         1,     12,     6),
                                (1101,         2,     6,      4),
                                (1101,         2,     6,      4);
...
insert into OrePriceAmount (orePriceId, oreId, amount)
                    values (11002,      1,     2),
                           (11002,      2,     1);
insert into MiningArea (id,   areaName,          orePriceId, sizeX, sizeY, maxMoves, miningTime, taxRate, aiRobotId)
                values (1102, 'Oxaria-Advanced', 11002,      25,    25,    150,      30,         10,      1102) ON DUPLICATE KEY UPDATE areaName = VALUES(areaName), orePriceId = VALUES(orePriceId), sizeX = VALUES(sizeX), sizeY = VALUES(sizeY), maxMoves = VALUES(maxMoves), miningTime = VALUES(miningTime), taxRate = VALUES(taxRate), aiRobotId = VALUES(aiRobotId);
insert into MiningAreaOreSupply (miningAreaId, oreId, supply, radius)
                         values (1102,         1,     20,     6),
                                (1102,         2,     8,      4),
                                (1102,         2,     6,      4),
...
insert into OrePriceAmount (orePriceId, oreId, amount)
                    values (18001,      6,     50),
                           ...
                           (18001,      8,     30);
insert into MiningArea (id,   areaName,        orePriceId, sizeX, sizeY, maxMoves, miningTime, taxRate, aiRobotId)
                values (1801, 'Asradon-Small', 18001,      100,   100,   2700,     10800,      80,      3) ON DUPLICATE KEY UPDATE areaName = VALUES(areaName), orePriceId = VALUES(orePriceId), sizeX = VALUES(sizeX), sizeY = VALUES(sizeY), maxMoves = VALUES(maxMoves), miningTime = VALUES(miningTime), taxRate = VALUES(taxRate), aiRobotId = VALUES(aiRobotId);
insert into MiningAreaOreSupply (miningAreaId, oreId, supply, radius)
                         values (1801,         2,     15,     15),
                                (1801,         2,     15,     15),
                                (1801,         3,     15,     15),
...
insert into OrePriceAmount (orePriceId, oreId, amount)
                    values (18002,      7,     50),
                           ...
                           (18002,      9,     30);
insert into MiningArea (id,   areaName,        orePriceId, sizeX, sizeY, maxMoves, miningTime, taxRate, aiRobotId)
                values (1802, 'Asradon-Large', 18002,      140,   140,   3600,     16200,      12,      3) ON DUPLICATE KEY UPDATE areaName = VALUES(areaName), orePriceId = VALUES(orePriceId), sizeX = VALUES(sizeX), sizeY = VALUES(sizeY), maxMoves = VALUES(maxMoves), miningTime = VALUES(miningTime), taxRate = VALUES(taxRate), aiRobotId = VALUES(aiRobotId);
insert into MiningAreaOreSupply (miningAreaId, oreId, supply, radius)
                         values (1802,         3,     15,     15),
                                (1802,         3,     15,     15),
                                (1802,         5,     15,     15),
...
insert into AchievementStep (achievementId, step, achievementPoints, oreId, maxOreReward, maxDepotReward)
                     values (9,             2,    10,                7,     350,          80);
insert into AchievementStepMiningTotalRequirement (achievementId, step, oreId, amount)
                                           values (9,             2,    7,     1000);

insert into AchievementStep (achievementId, step, achievementPoints, oreId, maxOreReward, maxDepotReward)
                     values (9,             3,    10,                7,     500,          160);
insert into AchievementStepMiningTotalRequirement (achievementId, step, oreId, amount)
                                           values (9,             3,    7,     3500);
...
insert into AchievementStep (achievementId, step, achievementPoints, oreId, maxOreReward, maxDepotReward)
                     values (10,            2,    10,                8,     450,          100);
insert into AchievementStepMiningTotalRequirement (achievementId, step, oreId, amount)
                                           values (10,            2,    8,     1400);

insert into AchievementStep (achievementId, step, achievementPoints, oreId, maxOreReward, maxDepotReward)
                     values (10,            3,    10,                8,     600,          200);
insert into AchievementStepMiningTotalRequirement (achievementId, step, oreId, amount)
                                           values (10,            3,    8,     5000);
...
insert into AchievementStepMiningTotalRequirement (achievementId, step, oreId, amount)
                                           values (12,            1,    8,     9000);
insert into AchievementStepMiningScoreRequirement (achievementId, step, miningAreaId, minimumScore)
                                           values (12,            1,    1702,         910.0);

insert into AchievementStep (achievementId, step, achievementPoints, oreId, maxOreReward, maxDepotReward)
                     values (12,            2,    10,                9,     450,          120);
insert into AchievementStepMiningTotalRequirement (achievementId, step, oreId, amount)
                                           values (12,            2,    9,     1500);

insert into AchievementStep (achievementId, step, achievementPoints, oreId, maxOreReward, maxDepotReward)
                     values (12,            3,    10,                9,     600,          250);
insert into AchievementStepMiningTotalRequirement (achievementId, step, oreId, amount)
                                           values (12,            3,    9,     6000);
...
insert into AchievementStepMiningTotalRequirement (achievementId, step, oreId, amount)
                                           values (12,            5,    9,     9000);
insert into AchievementStepMiningScoreRequirement (achievementId, step, miningAreaId, minimumScore)
                                           values (12,            5,    1801,         800.0),
                                                  (12,            5,    1802,         750.0);

insert into AchievementStep (achievementId, step, achievementPoints, miningQueueReward)
                     values (12,            6,    10,                1);
insert into AchievementStepMiningScoreRequirement (achievementId, step, miningAreaId, minimumScore)
                                           values (12,            6,    1801,         850.0),
                                                  (12,            6,    1802,         800.0);

insert into AchievementStep (achievementId, step, achievementPoints, oreId, maxOreReward, maxDepotReward)
                     values (12,            7,    10,                9,     2500,         500);
insert into AchievementStepMiningScoreRequirement (achievementId, step, miningAreaId, minimumScore)
                                           values (12,            7,    1801,         900.0),
                                                  (12,            7,    1802,         850.0);
insert into AchievementStepMiningTotalRequirement (achievementId, step, oreId, amount)
                                           values (12,            7,    9,     18000);
...
insert into AchievementStep (achievementId, step, achievementPoints, miningQueueReward)
                     values (12,            8,    10,                1);
insert into AchievementStepMiningScoreRequirement (achievementId, step, miningAreaId, minimumScore)
                                           values (12,            8,    1801,         950.0),
                                                  (12,            8,    1802,         900.0);

insert into AchievementStep (achievementId, step, achievementPoints, oreId, maxOreReward)
                     values (12,            9,    10,                9,     4000);
insert into AchievementStepMiningScoreRequirement (achievementId, step, miningAreaId, minimumScore)
                                           values (12,            9,    1801,         960.0),
                                                  (12,            9,    1802,         950.0);
insert into AchievementStepMiningTotalRequirement (achievementId, step, oreId, amount)
                                           values (12,            9,    9,     30000);
...
insert into AchievementStep (achievementId, step, achievementPoints, miningQueueReward)
                     values (12,            10,   10,                1);
insert into AchievementStepMiningScoreRequirement (achievementId, step, miningAreaId, minimumScore)
                                           values (12,            10,   1802,         960.0);

insert into AchievementStep (achievementId, step, achievementPoints, oreId, maxOreReward, maxDepotReward)
                     values (12,            11,   10,                9,     6000,         1000);
insert into AchievementStepMiningScoreRequirement (achievementId, step, miningAreaId, minimumScore)
                                           values (12,            11,   1801,         970.0),
                                                  (12,            11,   1802,         970.0);
insert into AchievementStepMiningTotalRequirement (achievementId, step, oreId, amount)
                                           values (12,            11,   9,     50000);

insert into AchievementStep (achievementId, step, achievementPoints, oreId, maxOreReward)
                     values (12,            12,   10,                9,     9999);
insert into AchievementStepMiningScoreRequirement (achievementId, step, miningAreaId, minimumScore)
                                           values (12,            12,   1801,         980.0),
                                                  (12,            12,   1802,         980.0);
insert into AchievementStepMiningTotalRequirement (achievementId, step, oreId, amount)
