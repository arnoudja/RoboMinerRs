...
depotMaxAllowed INT NOT NULL DEFAULT 0,
...
INDEX idx_mining_queue_robot_order (robotId, queueOrder)
);
...
maxDepotReward INT NOT NULL DEFAULT 0,
...
grant SELECT,INSERT,UPDATE,DELETE,CREATE,ALTER,INDEX,LOCK TABLES,SHOW VIEW on RoboMiner.* to robominer@localhost;
